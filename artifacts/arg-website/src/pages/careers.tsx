      ...
      <section className="bg-mist py-24 border-b border-rule">
        <div className="max-w-6xl mx-auto px-6 md:px-8">
          ...
          <div className="flex flex-col border-t border-rule">
            <div className="border-b border-rule py-12 flex flex-col md:flex-row gap-8 md:gap-16 items-start group hover:bg-paper/50 transition-colors -mx-6 px-6 md:mx-0 md:px-0">
              ...
              <div className="md:w-1/2">
                <h3 className="text-2xl font-serif text-ink mb-4">Collections Recovery Specialist</h3>
      ...
      <section className="bg-paper py-24">
        <div className="max-w-6xl mx-auto px-6 md:px-8 flex flex-col gap-8">
          ...
          <div className="flex justify-between items-start flex-col md:flex-row gap-4 text-xs font-mono text-slate">
            <p>Our headquarters in Fairfield, NJ.</p>
